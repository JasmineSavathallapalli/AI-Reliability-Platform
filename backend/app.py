...
from database import (
    save_query, get_query_count_today,
...
@app.route("/")
def home():
    return jsonify({"message": "AI Reliability Platform Backend Running Successfully!"})
    ...
    try:
        ...
        msg = Message(
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <h2 style="color: #3b82f6;">AI Reliability Platform</h2>
...
def query():
    try:
        ...
        if query_count >= DAILY_LIMIT:
            return jsonify({"error": f"Daily limit of {DAILY_LIMIT} queries reached."}), 429
